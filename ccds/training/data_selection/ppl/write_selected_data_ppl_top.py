...
if __name__ == "__main__":
    ...
    for target_task in args.target_task_names:
        ...
        reordered_indices = first_third_indices + middle_third_indices + bottom_third_indices
        ...
        selected_lm_datasets.to_json(f"{output_path}/{target_task}-train-p{args.percentage}-ppl-epoch{args.epochs_num}-top-ppl-{args.data_seed}.jsonl")
